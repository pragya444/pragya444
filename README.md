...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=DM+Sans&weight=500&size=20&pause=1000&color=38BDF8&center=true&vCenter=true&width=600&lines=Building+things+that+ship+and+last;AI+%C2%B7+Mobile+%C2%B7+Web+%C2%B7+Backend;Open+to+new-grad+SWE+roles)](https://pragya-portfolio-xi.vercel.app)
...
| Project | Description |
|---|---|
| [FieldNotes AI](https://pragya-portfolio-xi.vercel.app/#project-fieldnotes-ai) | Cross-platform client intake app for frontline social workers with on-device transcription, AI form auto-fill, offline sync, and FOIP/HIA/PIPA-compliant architecture for Jarillo Consulting |
